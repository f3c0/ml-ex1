...
%[t1, J1] = gradientDescentMulti(X, y, theta, 0.3, num_iters);
%[t2, J2] = gradientDescentMulti(X, y, theta, 0.1, num_iters);
%[t3, J3] = gradientDescentMulti(X, y, theta, 0.03, num_iters);
%[t4, J4] = gradientDescentMulti(X, y, theta, 0.01, num_iters);
